          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-4">
                ...
                <p>
                  Bring your world to life by turning on the recorder and demonstrating what you
                  want to happen! Watch as bits of code are written automatically and make the
                  changes you want.
                </p>
              </div>
              <div className="col-md-4">
            ...
            <div className="row">
              <div className="col-md-7">
                ...
                <p>
                  ...
                  using Apple's KidSIM and subsequently Stagecast Creator, and Codako is my effort
                  to bring back the platform that inspired me in my childhood. For more about why
                  I've built Codako, see the <Link to={"/faq"}>FAQ for Parents</Link>
                </p>
              </div>
              <div className="offset-md-2 col-md-3">
