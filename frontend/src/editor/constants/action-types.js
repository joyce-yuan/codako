...
export const REORDER_STAGE = 'REORDER_STAGE';

export const SELECT_STAGE_INDEX = 'SELECT_STAGE_INDEX';
...
export const UPDATE_RECORDING_ACTION_PREFS = 'UPDATE_RECORDING_ACTION_PREFS';
