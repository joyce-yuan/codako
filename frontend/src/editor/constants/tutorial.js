...
const baseTutorialSteps = [
  {
    ...
    soundURL: require('../sounds/tutorial/base_01.mp3'),
...

  {
    ...
    soundURL: require('../sounds/tutorial/base_02.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_03.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_04.mp3'),
    waitsFor: {
  ...
  },
  {
    ...
    the next lesson.
  `,
    soundURL: require('../sounds/tutorial/base_05.mp3'),
    annotation: {selectors: ['.tutorial-container button.btn-primary'], style: 'outline'},
    waitsFor: {
...

  {
    ...
    soundURL: require('../sounds/tutorial/base_06.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_07.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_08.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_11.mp3'),
  ...
  },
  {
    ...
    want to get rid of.`,
    soundURL: require('../sounds/tutorial/base_12.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_13.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_14.mp3'),
    annotation: {selectors: ['[data-tutorial-id=play]'], style: 'outline'},
    waitsFor: {
      stateMatching: (state, stage) => {
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_15.mp3'),
    annotation: {selectors: ['.tutorial-container button.btn-primary'], style: 'outline'},
    waitsFor: {
...

  {
    ...
    soundURL: require('../sounds/tutorial/base_16.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_17.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_18.mp3'),
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_19.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_20.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_21.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_24.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_25.mp3'),
    waitsFor: {
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_26.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_27.mp3'),
    annotation: {selectors: ['[data-tutorial-id=record-next-step]'], style: 'outline'},
    waitsFor: {
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_28.mp3'),
    annotation: {selectors: ['[data-tutorial-id=play]'], style: 'outline'},
    onEnter: (dispatch) => {
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_29.mp3'),
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_30.mp3'),
    annotation: {selectors: ['.tutorial-container button.btn-primary'], style: 'outline'},
    waitsFor: {
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_31.mp3'),
    annotation: {selectors: ['[data-stage-character-id=aamlcui8uxr]'], style: 'outline'},
    waitsFor: {
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_32.mp3'),
    annotation: {
      style: 'arrow',
      selectors: [
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_33.mp3'),
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_34.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_35.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_36.mp3'),
  },
  {
    pose: 'standing-pointing',
    text: `We'll need a new green Event block. Click 'Add' up here.`,
    soundURL: require('../sounds/tutorial/base_37.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_38.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_39.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_40.mp3'),
    annotation: {selectors: ['.rule-container.group-event:first-child'], style: 'outline'},
  },
  {
    pose: 'standing-pointing',
    text: `Drag and drop the climbing rule into the empty space inside our new green block.`,
    soundURL: require('../sounds/tutorial/base_41.mp3'),
    annotation: {
      style: 'arrow',
      selectors: [
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_42.mp3'),
    onEnter: (dispatch) => {
      dispatch(stopPlayback());
    },
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_43.mp3'),
    annotation: {selectors: ['[data-tutorial-id=play]'], style: 'outline'},
    waitsFor: {
      stateMatching: (state, stage) => {
        const main = Object.values(stage.actors).find(a => a.characterId === 'aamlcui8uxr');
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_44.mp3'),
    annotation: {selectors: ['.tutorial-container button.btn-primary'], style: 'outline'},
    waitsFor: {
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_45.mp3'),
    onEnter: (dispatch) => {
      dispatch(stopPlayback());
    },
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_46.mp3'),
    onEnter: (dispatch) => {
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_47.mp3'),
    annotation: {selectors: ['[data-tutorial-id=toolbar-tool-record]'], style: 'outline'},
    waitsFor: {
      stateMatching: (state) => {
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_48.mp3'),
  ...
  {
    pose: 'standing-pointing',
    soundURL: require('../sounds/tutorial/base_49.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_52.mp3'),
  },
  {
    pose: 'standing-pointing',
    text: `Click 'Save Recording' and let's try out your new rule.`,
    soundURL: require('../sounds/tutorial/base_53.mp3'),
    annotation: {selectors: ['[data-tutorial-id=record-next-step]'], style: 'outline'},
    waitsFor: {
      stateMatching: (state) => state.recording.characterId === null,
    },
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_54.mp3'),
    onEnter: (dispatch) => {
  ...
  },
  {
    ...
    text: `Hmm... The boulder moved over, but it didn't fall! I wonder what we forgot?
      ...
      fall down!`,
    soundURL: require('../sounds/tutorial/base_55.mp3'),
  },
  {
    pose: 'standing-confused',
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_58.mp3'),
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_59.mp3'),
    annotation: {selectors: ['[data-tutorial-id=record-next-step]'], style: 'outline'},
    waitsFor: {
      stateMatching: (state) => state.recording.phase === RECORDING_PHASE_RECORD,
    },
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_62.mp3'),
  },
  {
    pose: 'standing-pointing',
    text: `Click 'Save Recording' and let's try out your new rule.`,
    soundURL: require('../sounds/tutorial/base_63.mp3'),
    annotation: {selectors: ['[data-tutorial-id=record-next-step]'], style: 'outline'},
    waitsFor: {
      stateMatching: (state) => state.recording.characterId === null,
    },
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_64.mp3'),
    pose: 'sitting-talking',
    onEnter: (dispatch) => {
      dispatch(changeActor(baseTutorialBoulderPath, {position: {x: 14, y: 5}}));
      dispatch(changeActor(baseTutorialCharacterPath, {position: {x: 2, y: 9}}));
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_65.mp3'),
  },
  {
    ...
    soundURL: require('../sounds/tutorial/base_66.mp3'),
...
const forkTutorialSteps = [
  {
    ...
    soundURL: require('../sounds/tutorial/fork_01.mp3'),
    annotation: {selectors: ['.tutorial-container button.btn-primary'], style: 'outline'},
    waitsFor: {
  ...
  },
  {
    ...
    soundURL: require('../sounds/tutorial/fork_02.mp3'),
    annotation: {selectors: ['[data-tutorial-id=controls]'], style: 'outline'},
    waitsFor: {
      button: 'Next',
    },
  },
  {
    ...
    soundURL: require('../sounds/tutorial/fork_03.mp3'),
    annotation: {selectors: ['[data-tutorial-id=characters]'], style: 'outline'},
    waitsFor: {
      button: 'Next',
    },
  },
  {
    ...
    soundURL: require('../sounds/tutorial/fork_04.mp3'),
    annotation: {selectors: ['.stages-horizontal-flex'], style: 'outline'},
    waitsFor: {
      button: 'Next',
    },
  },
  {
    ...
    piece on the stage.`,
    soundURL: require('../sounds/tutorial/fork_05.mp3'),
    annotation: {selectors: ['[data-tutorial-id=toolbar-tool-record]'], style: 'outline'},
    waitsFor: {
      button: 'Next',
    },
